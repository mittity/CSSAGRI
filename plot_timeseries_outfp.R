...
flux.table <- read.csv(file="/work/mittity/CSSAGRI/plot_pdf/0806-1222_all.csv", heade=TRUE, row.names=NULL,sep=",")
#subset to high quility fluxes 
flux.table <- subset(flux.table, ((flux.table$flag.stat==TRUE)&(flux.table$flag.itc==TRUE)&(flux.table$flag.fpt==FALSE)))
